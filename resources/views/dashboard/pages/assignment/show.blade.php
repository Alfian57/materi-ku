    ...
    <div class="max-w-2xl">
        <div class="card">
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h2 class="text-lg font-bold">Grade Assignment</h2>
                    <p class="text-sm text-[rgb(var(--color-text-muted))]">{{ $assignment->student->name }}'s submission
                    </p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3 p-4 rounded-xl bg-gray-50 dark:bg-zinc-800 mb-6">
                <div class="avatar">
                    <div
                        ...
                        {{ strtoupper(substr($assignment->student->name, 0, 1)) }}</div>
                </div>
                <div>
            ...
            <form
                ...
                @csrf @method('PUT')
                <div>
                    <label for="point" class="form-label">Score (0-100)</label>
                    <input type="number" id="point" name="point" min="0" max="100"
                        value="{{ old('point', $assignment->score) }}"
                        class="form-input @error('point') is-invalid @enderror" placeholder="Enter score...">
