        ...
        <div class="card">
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-[rgb(var(--color-text-muted))]">Update student information</p>
                </div>
            </div>
            ...
            <form action="{{ route('dashboard.students.update', $student->id) }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $student->name) }}"
                        class="form-input @error('name') is-invalid @enderror" placeholder="Enter student name...">
                    @error('name')
                ...
                <div class="flex items-center justify-end gap-3 pt-4 border-t border-[rgb(var(--color-border))]">
                    <a href="{{ route('dashboard.students.index') }}" class="btn-ghost">Cancel</a>
