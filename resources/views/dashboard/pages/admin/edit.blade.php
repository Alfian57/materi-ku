        ...
        <div class="card">
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-[rgb(var(--color-text-muted))]">Perbarui informasi administrator</p>
                </div>
            </div>
            <form action="{{ route('dashboard.admins.update', $admin->id) }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $admin->name) }}"
                        class="form-input @error('name') is-invalid @enderror" placeholder="Masukkan nama admin...">
                ...
                <div class="flex items-center justify-end gap-3 pt-4 border-t border-[rgb(var(--color-border))]">
                    <a href="{{ route('dashboard.admins.index') }}" class="btn-ghost">Batal</a>
