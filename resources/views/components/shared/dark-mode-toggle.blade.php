...
@php
    $buttonClass = $style === 'rounded' 
        ? 'p-2 rounded-xl hover:bg-gray-100 dark:hover:bg-zinc-700 transition-colors'
        : 'w-9 h-9 rounded-full flex items-center justify-center hover:bg-gray-100 dark:hover:bg-zinc-800 transition-colors';
@endphp
