...
<div class="w-full">
    ...
    <textarea 
        ...
        {{ $attributes->merge([
            'class' => 'w-full px-4 py-3 rounded-xl bg-[rgb(var(--color-surface))] border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500 text-[rgb(var(--color-text))] placeholder-[rgb(var(--color-text-muted))] resize-none ' . ($error ? 'border-rose-500 focus:ring-rose-500/50 focus:border-rose-500' : 'border-[rgb(var(--color-border))]')
        ]) }}
